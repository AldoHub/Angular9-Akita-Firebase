...
export class MainComponent implements OnInit, OnDestroy {
  ...
  constructor(private postsService: PostsService, private postQuery: PostsQuery, private postStore: PostsStore) { }
  ...
  ngOnInit(): void {
    ...
    //untilDestroyed unsubscribe from the observable once the component is destroyed
    this.postsService.connect().pipe(untilDestroyed(this)).subscribe(() => {
      console.log(this.postStore["storeValue"]["entities"])
    });
